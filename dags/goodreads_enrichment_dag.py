...
@dag(
    ...
    # we could go. At one request every five seconds a record costs 8.2
    # seconds measured over a full run, so 200 records is about 27 minutes and
    # a run still finishes with well over a third of its hour spare.
    #
